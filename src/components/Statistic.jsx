  ...
  return (
    <div className="px-4 py-12 rounded-xl mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-5">
      <div className="max-w-xl mb-10 md:mx-auto md:text-center lg:max-w-2xl md:mb-12">
        <div>
          <p className="inline-block py-px mb-4 text-2xl font-semibold font-primary text-secondary tracking-wider uppercase rounded-full">
            Our Elevator Pitch
          </p>
        </div>
        <h2 className="max-w-lg mb-6 font-sans text-3xl font-bold font-primary leading-none tracking-tight text-secondary sm:text-4xl md:mx-auto">
          <span className="relative inline-block">
            <span className="relative">The Accountistry Advantage</span>
          </span>{' '}
        </h2>
        <p className="text-base font-primary text-secondary md:text-lg">
      ...
      <div className="relative bg-secondary w-full p-px mx-auto mb-4 overflow-hidden transition-shadow duration-300 border-primary rounded lg:mb-8 lg:max-w-4xl group hover:shadow-xl">
        ...
        <div className="relative flex flex-col sm:flex-row items-center justify-around h-full py-6 transition-colors duration-300 rounded-sm space-y-6 sm:space-y-0">
          <div className="flex-1 px-8 py-6 mt-[2%] text-center">
            <h6 className="text-4xl font-bold text-primary sm:text-5xl counter mb-4" data-target="30">
              $0
            </h6>
            <p className="text-center font-primary md:text-base text-primary">
              Average hourly rate for <br/>staff accountant or bookkeeper
            </p>
          </div>
          
          <div className="w-[80%] h-1 sm:w-1 sm:h-48 transition duration-300 transform bg-primary rounded-full group-hover:scale-[1.2]" />

          <div className="flex-1 px-8 py-6 text-center">
            <h6 className="text-4xl font-bold text-primary sm:text-5xl counter mb-4" data-target="50">
              0%
            </h6>
            <p className="text-center font-primary md:text-base text-primary">
          ...
          <div className="flex-1 px-8 py-6 text-center">
            <div className="flex items-center justify-center">
              <h6 className="text-4xl font-bold text-primary sm:text-5xl counter mb-4" data-target="10">
                0/10
              </h6>
