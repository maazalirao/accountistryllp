        ...
        <div className="relative min-h-screen w-screen bg-grey-900">
            ...
            >
                <div className="w-[90%] max-w-7xl px-5 md:px-10">
                        ...
                        {[
                            {
                                ...
                                icon: <svg className="w-8 h-8" fill="currentColor" viewBox="0 0 24 24"><path d="M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zM9 17H7v-7h2v7zm4 0h-2V7h2v10zm4 0h-2v-4h2v4z"/></svg>
                            },
                            {
                    ...
                    {/* Centered Offshore Placements Service */}
                    <motion.div 
                        variants={containerVariants}
